...
import 'package:grimity/domain/usecase/feed/increment_feed_view_count_usecase.dart';
...
final updateFeedUseCase = getIt<UpdateFeedUseCase>();
final deleteFeedUseCase = getIt<DeleteFeedUseCase>();
...
final incrementFeedViewCountUseCase = getIt<IncrementFeedViewCountUseCase>();
