...
import 'package:grimity/app/model/push_notification_data.dart';
import 'package:grimity/app/util/device_info_util.dart';
import 'package:grimity/data/gen/models/notification_response.dart';
...
class PushNotification {
  ...
  static void onMessageClicked(RemoteMessage message) {
    if (message.data.isNotEmpty) {
      final response = PushNotificationData.fromJson(message.data);
      ...
      if (event == "newNotification") {
        ...
        getIt<RestClient>().notifications.notificationRead(id: model.id);
      }
